...
urlpatterns = [
    ...
    # Companion Report
    path('companion_report_list/', views.CompanionReportListClass.as_view(), name='companion_report_list'),
    path('add-companion-report/', views.AddCompanionReportClass.as_view(), name='add_companion_report'),
    path('edit-companion-report/', views.EditCompanionReportClass.as_view(), name='edit_companion_report'),
]
